...
agg.add_directory(directory=output_path / "database" / "scrape" / dataset_name / name)
...
# for latent_summary in agg.values("latent.latent_summary"):
#     instance = latent_summary.max_log_likelihood()
#     print(f"\n****Max Log Likelihood (latent_summary)****\n\n{instance}")
#     assert instance.gaussian.fwhm > 0.0
#     print(latent_summary.max_log_likelihood_sample.log_likelihood)
